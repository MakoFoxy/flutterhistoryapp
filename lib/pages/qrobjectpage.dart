    ...
    Future<void> changeAudio(newAudioUrl) async {
      if (audioDisplayed == newAudioUrl) {
        if (_audioPlayerQR.playing || audioDisplayed.isNotEmpty) {
          await _audioPlayerQR.stop(); // Остановить текущий трек, если он играет
        }
      }
